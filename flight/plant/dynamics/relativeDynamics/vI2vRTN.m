...
relativeState_rtn(1:3) = R_eci2rtn * relativeState_I(1:3, 1);
relativeState_rtn(4:6) = R_eci2rtn * relativeState_I(4:6, 1);
% Transform velocity
w_I2rtn = [0, 0, theta0_dot];
relativeState_rtn(4:6) = relativeState_rtn(4:6) + cross(w_I2rtn, relativeState_rtn(1:3));
