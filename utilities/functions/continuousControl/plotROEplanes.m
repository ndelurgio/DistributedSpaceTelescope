...
plot(a*telem.("Chief Mean Eccentric Singular ROE True.relativeLongitude")(telem.("Chief Thrust Cmd") == 1),a*telem.("Chief Mean Eccentric Singular ROE True.relativeSemiMajorAxis")(telem.("Chief Thrust Cmd") == 1),'Color','red',LineWidth=2)
...
plot(a*telem.("Chief Mean Eccentric Singular ROE True.relativeEccentricityX")(telem.("Chief Thrust Cmd") == 1),a*telem.("Chief Mean Eccentric Singular ROE True.relativeEccentricityY")(telem.("Chief Thrust Cmd") == 1),'Color','red',LineWidth=2)
...
plot(a*telem.("Chief Mean Eccentric Singular ROE True.relativeInclinationX")(telem.("Chief Thrust Cmd") == 1),a*telem.("Chief Mean Eccentric Singular ROE True.relativeInclinationY")(telem.("Chief Thrust Cmd") == 1),'Color','red',LineWidth=2)
