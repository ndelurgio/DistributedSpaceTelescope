...
grid on;
hold on;
plot(time/3600,a*telem.("Osculating D'Amico ROE True.relativeSemiMajorAxis"),LineWidth=2)
...
grid on;
hold on;
plot(time/3600,a*telem.("Osculating D'Amico ROE True.relativeLongitude"),LineWidth=2)
...
grid on;
hold on;
plot(time/3600,a*telem.("Osculating D'Amico ROE True.relativeEccentricityX"),LineWidth=2)
...
grid on;
hold on;
plot(time/3600,a*telem.("Osculating D'Amico ROE True.relativeEccentricityY"),LineWidth=2)
...
grid on;
hold on;
plot(time/3600,a*telem.("Osculating D'Amico ROE True.relativeInclinationX"),LineWidth=2)
...
grid on;
hold on;
plot(time/3600,a*telem.("Osculating D'Amico ROE True.relativeInclinationY"),LineWidth=2)
