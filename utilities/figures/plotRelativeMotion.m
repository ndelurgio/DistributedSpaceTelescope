function [] = plotRelativeMotion(time, telem, plot_type)
    ...
    if plot_type == "solo"
        ...
        plot(telem.("Relative Cartesian State RTN")(1:end,2),telem.("Relative Cartesian State RTN")(1:end,1))
        ...
        plot(telem.("Relative Cartesian State RTN")(1:end,3),telem.("Relative Cartesian State RTN")(1:end,1))
