...
grid on;
hold on;
plot(t(1:6:length(roe)*6),abs(a*(da(1:6:length(roe)*6)-roe(1,:)')),LineWidth=2)
...
grid on;
hold on;
plot(t(1:6:length(roe)*6),abs(a*(dlam(1:6:length(roe)*6)-roe(2,:)')),LineWidth=2)
% legend(["SRP & Secular J2","Only Secular J2"])
xlabel("t [hr]")
...
grid on;
hold on;
plot(t(1:6:length(roe)*6),abs(a*(dex(1:6:length(roe)*6)-roe(3,:)')),LineWidth=2)
% legend(["SRP & Secular J2","Only Secular J2"])
xlabel("t [hr]")
...
grid on;
hold on;
plot(t(1:6:length(roe)*6),abs(a*(dey(1:6:length(roe)*6)-roe(4,:)')),LineWidth=2)
% legend(["SRP & Secular J2","Only Secular J2"])
xlabel("t [hr]")
...
grid on;
hold on;
plot(t(1:6:length(roe)*6),abs(a*(dix(1:6:length(roe)*6)-roe(5,:)')),LineWidth=2)
% legend(["SRP & Secular J2","Only Secular J2"])
xlabel("t [hr]")
...
grid on;
hold on;
plot(t(1:6:length(roe)*6),a*(diy(1:6:length(roe)*6)-roe(6,:)'),LineWidth=2)
% legend(["SRP & Secular J2","Only Secular J2"])
xlabel("t [hr]")
