...
grid on;
hold on;
plot(time/3600,da_nav-da_true,LineWidth=2)
...
grid on;
hold on;
plot(time/3600,dlam_nav-dlam_true,LineWidth=2)
% legend(["SRP & Secular J2","Only Secular J2"])
xlabel("t [hr]")
...
grid on;
hold on;
plot(time/3600,dex_nav-dex_true,LineWidth=2)
% legend(["SRP & Secular J2","Only Secular J2"])
xlabel("t [hr]")
...
grid on;
hold on;
plot(time/3600,dey_nav-dey_true,LineWidth=2)
% legend(["SRP & Secular J2","Only Secular J2"])
xlabel("t [hr]")
...
grid on;
hold on;
plot(time/3600,dix_nav-dix_true,LineWidth=2)
% legend(["SRP & Secular J2","Only Secular J2"])
xlabel("t [hr]")
...
grid on;
hold on;
plot(time/3600,(diy_nav-diy_true),LineWidth=2)
% legend(["SRP & Secular J2","Only Secular J2"])
xlabel("t [hr]")
